...
M_0 = np.array([0.82, 1])
m_dot = np.array([290, 1])
eta_inlet = np.array([0.97, 1])
pi_fan = np.array([1.65, 1])
eta_fan = np.array([0.93, 1])
bypass_ratio = np.array([5, 1])
eta_LPC = np.array([0.9, 1])
eta_HPC = np.array([0.9, 1])
eta_LPT = np.array([0.91, 1])
eta_HPT = np.array([0.91, 1])
eta_mech = np.array([0.99, 1])
eta_gear = np.array([0.99, 1])
eta_cc = np.array([0.99, 1])
pi_LPC = np.array([5, 1])
pi_HPC = np.array([12, 1])
eta_nozzle = np.array([0.98, 1])
pi_cc = np.array([0.96, 1])
T_04 = np.array([1600, 1])
T_046 = np.array([1600, 1])
...
# Part 10
m_dot_f_H2 = (m_dot_HOT*cp_gas*(T_04-T_03)) / (LHV_H2*eta_cc)
print("m_dot_f_H2 = "+str(m_dot_f_H2))
...
T_045 = ((W_HPT / ((m_dot_HOT + m_dot_f_H2)*cp_gas))-T_04)*-1
...
# Part 15
m_dot_f_ker = ((m_dot_HOT + m_dot_f_H2)*cp_gas*(T_046-T_045)) / (LHV*eta_cc)
print("m_dot_f_ker = "+str(m_dot_f_ker))

# Part 16
P_046 = P_045*pi_cc
print("P_046 = "+str(P_046))

# Part 17
W_LPT = (W_LPC + W_fan / eta_gear) / eta_mech
T_05 = ((W_LPT / ((m_dot_HOT + m_dot_f_H2 + m_dot_f_ker)*cp_gas))-T_046)*-1
print("T_05 = "+str(T_05))

# Part 18
P_05 = P_046*(1-(1-(T_05/T_046))/eta_LPT)**(k_gas/(k_gas-1))
print("P_05 = "+str(P_05))
...
T_core = (m_dot_HOT + m_dot_f_H2 + m_dot_f_ker)*(V_8 - V_0) + (((m_dot_HOT + m_dot_f_H2 + m_dot_f_ker)*R*T_8)*(P_8 - P_amb))/(P_8*V_8)
T_tot = T_fan + T_core
...
# Part 26
SFC = (m_dot_f_H2 + m_dot_f_ker) / T_tot
print("SFC = "+str(SFC))